...
public class Vehiculos extends AppCompatActivity {
    String idActual;
    EditText matricula, marca, modelo, año, matriculaEli;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marca = findViewById(R.id.editTextText9);
        ...
        añadir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!matri.isEmpty() && !marc.isEmpty() && !model.isEmpty() && !an.isEmpty() && !itemSeleccionado.isEmpty()){
